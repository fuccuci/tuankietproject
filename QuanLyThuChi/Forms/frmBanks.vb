...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents dgridNganHang As System.Windows.Forms.DataGrid
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(frmBanks))
        Me.GroupBox1 = New System.Windows.Forms.GroupBox
        Me.txttendaily = New System.Windows.Forms.TextBox
        Me.txtmadaily = New System.Windows.Forms.TextBox
        Me.Label2 = New System.Windows.Forms.Label
        Me.Label1 = New System.Windows.Forms.Label
        Me.dgridNganHang = New System.Windows.Forms.DataGrid
        ...
        CType(Me.dgridNganHang, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(561, 80)
        ...
        Me.txttendaily.Size = New System.Drawing.Size(466, 26)
        ...
        Me.txtmadaily.Size = New System.Drawing.Size(466, 26)
        ...
        Me.Label1.Text = "Mã NH"
        '
        'dgridNganHang
        '
        Me.dgridNganHang.DataMember = ""
        Me.dgridNganHang.HeaderForeColor = System.Drawing.SystemColors.ControlText
        Me.dgridNganHang.Location = New System.Drawing.Point(10, 136)
        Me.dgridNganHang.Name = "dgridNganHang"
        Me.dgridNganHang.ReadOnly = True
        Me.dgridNganHang.Size = New System.Drawing.Size(557, 200)
        Me.dgridNganHang.TabIndex = 76
        '
        'GroupBox2
        '
        ...
        Me.GroupBox2.Location = New System.Drawing.Point(11, 330)
        Me.GroupBox2.Name = "GroupBox2"
        Me.GroupBox2.Size = New System.Drawing.Size(556, 48)
        ...
        Me.cmdDelete.Location = New System.Drawing.Point(287, 14)
        Me.cmdDelete.Name = "cmdDelete"
        Me.cmdDelete.Size = New System.Drawing.Size(72, 26)
        Me.cmdDelete.TabIndex = 18
        Me.cmdDelete.Text = "Bỏ Qua"
        '
        'cmdSaveEmployee
        '
        ...
        Me.cmdSaveEmployee.Location = New System.Drawing.Point(194, 14)
        ...
        Me.cmdClosed.Location = New System.Drawing.Point(464, 16)
        ...
        Me.cmdEditEmployee.Location = New System.Drawing.Point(101, 14)
        ...
        Me.Label9.Size = New System.Drawing.Size(564, 48)
        Me.Label9.TabIndex = 74
        Me.Label9.Text = "DANH MỤC  NGÂN HÀNG"
        ...
        Me.Controls.Add(Me.dgridNganHang)
        ...
        Me.Text = "Danh Mục Ngân Hàng"
        Me.GroupBox1.ResumeLayout(False)
        CType(Me.dgridNganHang, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Sub FormatDataGridNganHang()

        With dgridNganHang
            .AllowNavigation = False
            .DataMember = "Tbl_Banks"
        ...
        With TblStyle
            ...
            End With
        End With
        dgridNganHang.TableStyles.Add(TblStyle)
    End Sub
    ...
    Private Sub FillDataset(ByVal strQuery As String)
        Try
            ...
            da.Fill(ds, "Tbl_Banks")
            dgridNganHang.DataSource = ds.Tables("Tbl_Banks")
        Catch ex As Exception
    ...
    Private Sub SaveDataSource(ByVal strMaDL As String, ByVal strTenDL As String)
        Dim sql As String
        If flag = "_Add" Then
            sql = "INSERT INTO Tbl_Banks(Bank_Code,Bank_Name) VALUES('" & strMaDL & "','" & strTenDL & "')"
        Else
            sql = "UPDATE Tbl_Banks SET Bank_Code='" & strMaDL & "' , Bank_Name='" & strTenDL & "'  WHERE Bank_Code='" & varMaDL & "'"
        End If
        Try
        ...
        Catch ex As Exception
            MsgBox("Lổi Cập Nhật :" & ex.ToString)
        End Try
        FillDataset(strSQL)
        BindingTextBox()
        oledbcon.Close()
    ...
    Private Sub cmdSaveEmployee_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSaveEmployee.Click
        If txtmadaily.Text = "" Then
            MsgBox("Mã Ngân Hàng Không Được Rỗng!!!", MsgBoxStyle.Information + MsgBoxStyle.OKOnly, "Chú ý")
            Exit Sub
        End If
    ...
    Private Sub BindingTextBox()
        Try
            ...
            txtmadaily.DataBindings.Add("Text", ds.Tables("Tbl_Banks"), "Bank_Code")
            txttendaily.DataBindings.Add("Text", ds.Tables("Tbl_Banks"), "Bank_Name")
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    End Sub
    ...
    Private Sub frmBanks_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
        flag = ""
    End Sub

    Private Sub frmBanks_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        FormatDataGridNganHang()
        strSQL = "SELECT * FROM Tbl_Banks "
        FillDataset(strSQL)
        BindingTextBox()
        cmdNewEmployee.Focus()
