...
Public Class frmTongHopThuTheoKyCuoc
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents DateTimePickerTuchuky As System.Windows.Forms.DateTimePicker
    Friend WithEvents Label11 As System.Windows.Forms.Label
    Friend WithEvents DateTimePickerDenChuKy As System.Windows.Forms.DateTimePicker
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.DateTimePickerTuchuky = New System.Windows.Forms.DateTimePicker
        Me.Label11 = New System.Windows.Forms.Label
        Me.DateTimePickerDenChuKy = New System.Windows.Forms.DateTimePicker
        ...
        Me.cmdclose.Location = New System.Drawing.Point(304, 221)
        ...
        Me.cmdxem.Location = New System.Drawing.Point(144, 221)
        ...
        'GroupBox1
        '
        Me.GroupBox1.Controls.Add(Me.DateTimePickerDenChuKy)
        Me.GroupBox1.Controls.Add(Me.Label1)
        Me.GroupBox1.Controls.Add(Me.DateTimePickerTuchuky)
        ...
        Me.GroupBox1.Size = New System.Drawing.Size(526, 184)
        ...
        Me.txttendichvu.Location = New System.Drawing.Point(248, 75)
        ...
        Me.Cbolydo.Location = New System.Drawing.Point(79, 74)
        ...
        Me.CheckBoxBaocaonhanh.Location = New System.Drawing.Point(10, 158)
        ...
        Me.CheckBoxPSTNDL.Location = New System.Drawing.Point(280, 134)
        ...
        Me.dtpdenngay.Size = New System.Drawing.Size(128, 26)
        ...
        Me.CboEmploy_code.Location = New System.Drawing.Point(79, 104)
        ...
        Me.txtEmployeeName.Location = New System.Drawing.Point(248, 105)
        ...
        Me.CheckBoxDetail.Location = New System.Drawing.Point(10, 134)
        ...
        '
        'DateTimePickerTuchuky
        '
        Me.DateTimePickerTuchuky.CustomFormat = "MM/yyyy"
        Me.DateTimePickerTuchuky.Format = System.Windows.Forms.DateTimePickerFormat.Custom
        Me.DateTimePickerTuchuky.Location = New System.Drawing.Point(79, 45)
        Me.DateTimePickerTuchuky.Name = "DateTimePickerTuchuky"
        Me.DateTimePickerTuchuky.Size = New System.Drawing.Size(128, 26)
        Me.DateTimePickerTuchuky.TabIndex = 93
        Me.DateTimePickerTuchuky.Value = New Date(2006, 1, 1, 0, 0, 0, 0)
        '
        'Label11
        '
        ...
        Me.Label11.Text = "Từ Chu kỳ"
        '
        'DateTimePickerDenChuKy
        '
        Me.DateTimePickerDenChuKy.CustomFormat = "MM/yyyy"
        Me.DateTimePickerDenChuKy.Format = System.Windows.Forms.DateTimePickerFormat.Custom
        Me.DateTimePickerDenChuKy.Location = New System.Drawing.Point(296, 44)
        Me.DateTimePickerDenChuKy.Name = "DateTimePickerDenChuKy"
        Me.DateTimePickerDenChuKy.Size = New System.Drawing.Size(128, 26)
        Me.DateTimePickerDenChuKy.TabIndex = 95
        Me.DateTimePickerDenChuKy.Value = New Date(2006, 1, 1, 0, 0, 0, 0)
        '
        'Label1
        '
        Me.Label1.AutoSize = True
        Me.Label1.ForeColor = System.Drawing.SystemColors.Desktop
        Me.Label1.Location = New System.Drawing.Point(216, 47)
        Me.Label1.Name = "Label1"
        Me.Label1.Size = New System.Drawing.Size(85, 22)
        Me.Label1.TabIndex = 96
        Me.Label1.Text = "Đến Chu kỳ"
        '
        'frmTongHopThuTheoKyCuoc
        '
        ...
        Me.Name = "frmTongHopThuTheoKyCuoc"
        Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
        Me.Text = "Báo cáo tổng hợp thu cước theo kỳ cước"
    ...
    Private Sub cmdxem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdxem.Click
                ...
                Case "TM"
                    ...
                    If CheckBoxDetail.Checked Then
                        ...
                        If (CheckBoxPSTNDL.Checked) Then
                            ...
                            strQuery = "SELECT Tbl_TNDN.Receipt_Date AS Recei_Date, Tbl_TNDN.Ordinal_No AS Recei_NoTNDN, Tbl_Receipts.Ordinal_No AS Recei_NoDS, Tbl_Expenses.Ordinal_No AS Expen_No, Tbl_Daily.TenDL AS AgentName, Tbl_Daily.MaDL AS ISDN, Tbl_Receipts.Charge_Cycle, Tbl_Receipts.Total_Money AS ReceiMoneyDS, Tbl_TNDN.Total_Money AS ReceiMoneyTNDN, Tbl_Expenses.Total_Money AS ExpenMoneyHH, Tbl_Receipts.Total_Money+Tbl_TNDN.Total_Money-Tbl_Expenses.Total_Money AS RealRevenue, Tbl_TNDN.Employ_Code+'-'+Tbl_Employee.Employ_Name AS Employ_Code " & _
                            " FROM  (((Tbl_Receipts AS Tbl_TNDN INNER JOIN Tbl_Receipts ON Tbl_TNDN.STTDL = Tbl_Receipts.STTDL) INNER JOIN Tbl_Expenses ON Tbl_Receipts.STTDL = Tbl_Expenses.STTDL) INNER JOIN Tbl_Employee ON Tbl_TNDN.Employ_Code = Tbl_Employee.Employ_Code) INNER JOIN Tbl_Daily ON Tbl_TNDN.TenDaily = Tbl_Daily.MaDL " & _
                            " WHERE ((Tbl_TNDN.Receipt_Date) Between #" & dtptungay.Value.ToShortDateString & "# And #" & dtpdenngay.Value.ToShortDateString & "#) " & _
                            " AND ((Tbl_Receipts.Charge_Cycle) Between #" & DateTimePickerTuchuky.Text & "# And #" & DateTimePickerDenChuKy.Text & "#) " & _
                            " AND ((Tbl_Receipts.STTDL)>0) " & _
                            " AND ((Tbl_TNDN.Service_Code)='PSTNTNDN') " & _
                            " AND ((Tbl_Receipts.Service_Code)='PSTNDS')"
        ...
        Else
            If (Cbolydo.Text <> "") Then
                ...
                strQuery = strQuery & _
                " WHERE (((Tbl_Receipts.Receipt_Date) Between #" & dtptungay.Value.ToShortDateString & "# AND #" & dtpdenngay.Value.ToShortDateString & "# )" & _
                " AND ((Tbl_Receipts.Charge_Cycle) Between #" & DateTimePickerTuchuky.Text & "# AND #" & DateTimePickerDenChuKy.Text & "# )" & _
                " AND ((Tbl_Employee.StationID)='" & cbostations.SelectedValue & _
                "' AND ((Tbl_Receipts.Service_Code)='" & Cbolydo.Text & "')))"
