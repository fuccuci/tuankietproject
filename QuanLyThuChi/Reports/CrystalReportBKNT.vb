...
Public Class CrystalReportBKNT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyCTV.CrystalReportBKNT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportBKNT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportBKNT = New CrystalReportBKNT()
        rpt.Site = Me.Site
        Return rpt
    End Function
