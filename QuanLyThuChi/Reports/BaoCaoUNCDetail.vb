...
Public Class BaoCaoUNCDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyCTV.BaoCaoUNCDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBaoCaoUNCDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BaoCaoUNCDetail = New BaoCaoUNCDetail()
        rpt.Site = Me.Site
        Return rpt
    End Function
