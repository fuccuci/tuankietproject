...
Public Class CrystalReportGNT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyCTV.CrystalReportGNT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportGNT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportGNT = New CrystalReportGNT()
        rpt.Site = Me.Site
        Return rpt
    End Function
