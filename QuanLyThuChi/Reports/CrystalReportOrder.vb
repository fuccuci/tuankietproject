...
Public Class CrystalReportOrder
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "QuanLyCTV.CrystalReportOrder.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalReportOrder
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalReportOrder = New CrystalReportOrder()
        rpt.Site = Me.Site
        Return rpt
    End Function
